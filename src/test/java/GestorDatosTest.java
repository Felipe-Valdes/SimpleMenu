...
class GestorDatosTest {
    ...
    @BeforeEach
    void setUp() {gestor = new GestorDatos();
    }

    @AfterEach
    void tearDown() {gestor=null;
    }
    ...
    void imprimirBoleta() throws IOException {
        ...
        int resultadoObtenido=(metodo.nCompletos*metodo.precioCompletos)+(metodo.nSopaipillas*metodo.precioSopaipillas)+(metodo.nPanesConQueso*metodo.precioPanConQueso);
